...
AsteroidBelt::AsteroidBelt(std::shared_ptr<Mesh> asteroidMesh, unsigned int count)
...
void AsteroidBelt::Render(GLint projectionLoc, GLint viewLoc, GLint useInstancingLoc,
